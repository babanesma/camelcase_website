...
<div>
    <a href="<?php echo $node_url; ?>" class="pic">
        <img src="<?php echo $original_image; ?>" width="270" height="220" alt="">
    </a>
    <div class="info">
        ...
        <p>
            ...
            if (isset($node->body['und'])) {
                ...
                $summary = (strlen($summary) > 58) ? substr($summary, 0, 55) . '...' : $summary;
                echo $summary;
            }
            ?>
        </p>
        <a href="<?php echo $node_url; ?>" class="button btn-viewmore"><?php print t('View More'); ?></a>
    </div>
</div>