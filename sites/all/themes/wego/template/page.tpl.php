...
<div class="page <?php if (theme_get_setting('layout_option') == 'boxed') { echo 'page-boxed'; } ?>">
    ...
    <div class="page-content">
        ...
        <?php if ($coming_soon_v2 == 0 && $error_404_v2 == 0): ?>
            <!-- page content section -->
            <div class="page-content-section <?php if ($error_404_v1 > 0) { echo 'page-content-section-border'; } ?>">
				<div class="grid-row <?php if ($is_portfolio > 0) { echo 'portfolio-details'; } ?>">
        <?php endif; ?>
			...
			<?php elseif ( $page['sidebar_left'] && !$page['sidebar_right'] ) : ?>
				<div class="grid-col grid-col-3 sidebar_left <?php if (request_path() == 'shop-grid-v2' || request_path() == 'shop-list-v2') { echo 'grid-col-right'; } ?>">
					<?php print render($page['sidebar_left']); ?>
				</div>
				<div class="grid-col grid-col-9 main_content <?php if (request_path() == 'shop-grid-v2' || request_path() == 'shop-list-v2') { echo 'grid-col-right'; } ?>">
					<?php
						// check porfolio page to show top content
						if ($is_portfolio > 0) {
							print render($page['top_content']);
			...
			<?php elseif ( $page['sidebar_left'] && $page['sidebar_right'] ) : ?>
				<div class="grid-col grid-col-3 sidebar_left">
					<?php print render($page['sidebar_left']); ?>
				</div>
				<div class="grid-col grid-col-6 main_content">
					<?php
						// check porfolio page to show top content
						if ($is_portfolio > 0) {
							print render($page['top_content']);
